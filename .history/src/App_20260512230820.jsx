...
//   const [showCustomers, setShowCustomers] = useState(false); // 🔥 جديد
...
//   // FUNCTION BACKUP DOWNLOADED ON PC
...
//         ➕
//       </button>
//       <button className="plus" onClick={() => setShowCustomers(!showCustomers)}>👥</button>
//       <button className="plus" onClick={backupData}>💾 Backup</button>
...
//         <div className="modal-overlay">
//           <div className="modal">
//             <button className="plus" onClick={() => setShowCustomers(false)}>✖</button>
...
export default function App() {
  ...
  return (
    <div className="app">
     ...
     <button className="plus" onClick={() => setShowForm(!showForm)}>
      ...
      <button className="plusone"  onClick={backupData}>💾</button>
      <button className="plustwo"  onClick={() => navigate("/stock")}>📦</button>
      <button className="plustwo"  onClick={() => navigate("/suppliers")}>🏭</button>
  ...
  onClick={() => {
    ...
    const soldGold =
      Number(totalWeight21 || 0) -
      Number(totalPaidGold || 0);

    currentGold -= soldGold;
    ...
    const newInvoice = {
      ...
      totalWeight21,
      totalPaid21: totalPaidGold,

      workmanshipTotal: totalWorkmanship,
      remainingWorkmanship: remainingWork,
