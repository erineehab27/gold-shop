...
stock.gold21 = Number(stock.gold21 || 0) - totalWeight21;

// إضافة الكاش (مصنعية)
stock.cash = Number(stock.cash || 0) + Number(payWorkmanshipNow || 0);

// لو العميل دفع دهب
stock.gold21 += Number(payGold || 0);

// لو دفع 24
stock.gold21 += payGold24_to21;

// لو سبيكة
stock.gold21 += barEquivalent21;
...
localStorage.setItem("stock", JSON.stringify(stock));
  ...
  return (
    <div className="app">
      ...
      <button className="plus" onClick={() => setShowCustomers(!showCustomers)}>👥</button>
      <button className="plus" onClick={backupData}>💾 Backup</button>
      <button className="plus" onClick={() => navigate("/stock")}>📦</button>
