...
export default function App() {
  ...
  // تحويلات
  const to21_from24 = (w) => w * (999.9 / 875);
  const nuggetTo21 = (w) => w * (991 / 875);
  const barTo21 = (w, k) => (w * k) / 875;
  const cashTo21 = (cash, price) => (price ? cash / price : 0);
  ...
  const addInvoice = (e) => {
    ...
    const totalWeight21 = w21 + eq21_from24;

    // المصنعيات
    const workmanshipTotal =
    ...
    const remainingGold = totalWeight21 - totalPaid21;
      ...
      <div className="grid">
        ...
        <section className="card">
          ...
          <form onSubmit={addInvoice}>
            ...
            <input
              placeholder="وزن سبيكة"
              onChange={(e) =>
                setInvoiceForm({
                  ...invoiceForm,
                  payBarWeight: e.target.value,
                })
              }
            />

            <input
              placeholder="عيار السبيكة"
              onChange={(e) =>
                setInvoiceForm({
                  ...invoiceForm,
                  payBarKarat: e.target.value,
                })
              }
            />
            ...
            <input
              placeholder="سعر ذهب 21"
              onChange={(e) =>
                setInvoiceForm({
                  ...invoiceForm,
                  goldPrice21: e.target.value,
                })
              }
            />
            ...
            <tbody>
              {customerInvoices.map((inv) => (
                <tr key={inv.id}>
                  ...
                  <td>{inv.remainingGold.toFixed(2)}</td>
                  <td>{inv.date}</td>
                </tr>
              ))}
            </tbody>
