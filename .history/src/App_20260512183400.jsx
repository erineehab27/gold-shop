...
export default function App() {
  ...
  return (
    <div className="app">
     ...
     <button  onClick={() => setShowForm(!showForm)}>
      ...
      <button  onClick={() => setShowCustomers(!showCustomers)}>👥</button>
     </div>
      <div>     
         <button className="transformation" onClick={backupData}>💾 Backup</button>
      <button className="transformation" onClick={() => navigate("/stock")}>📦</button>
      <button className="transformation" onClick={() => navigate("/suppliers")}>🏭</button></div>
  ...
  onClick={() => {
    ...
    // 🔥 خصم الفاتورة
    currentGold -= Number(totalWeight21 || 0);
