...
export default function App() {
  ...
  const totalPaidGold =
    Number(payGold || 0) + payGold24_to21;
      ...
      <section className="card">
        ...
        {showForm && (
          <div className="popup">
            ...
            <input placeholder="اسم" onChange={(e) => setNewItem({ ...newItem, name: e.target.value })} />
            <input placeholder="عدد" onChange={(e) => setNewItem({ ...newItem, count: e.target.value })} />
            <input placeholder="وزن" onChange={(e) => setNewItem({ ...newItem, weight: e.target.value })} />
            <input placeholder="عيار" onChange={(e) => setNewItem({ ...newItem, karat: e.target.value })} />

            <select onChange={(e) => setNewItem({ ...newItem, type: e.target.value })}>
              <option value="gram">جرام</option>
              <option value="piece">قطعة</option>
            </select>

            <input placeholder="مصنعية" onChange={(e) => setNewItem({ ...newItem, workmanship: e.target.value })} />

            <button onClick={addItemFromForm}>✔️ حفظ</button>
        ...
        <h3>سداد جديد</h3>
        <input placeholder="دهب 21" onChange={(e) => setPayGold(e.target.value)} />
        <input placeholder="دهب 24" onChange={(e) => setPayGold24(e.target.value)} />
        <input placeholder="مصنعية" onChange={(e) => setPayWorkmanshipNow(e.target.value)} />
        <input placeholder="كاش باك" onChange={(e) => setCashBack(e.target.value)} />
