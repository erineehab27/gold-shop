...
import { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom"; // 🔥 لازم تضيفي دا
import "./App.css";

export default function App() {
  const navigate = useNavigate(); // 🔥 ودا كمان
        ...
        <section className="card">
          ...
          <button
            onClick={() =>
              navigate("/print", {
                state: {
                  customer: selectedCustomer, // ❗ كان غلط
                  invoices: customerInvoices // ❗ الصح
                }
              })
            }
          >
